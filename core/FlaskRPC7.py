...
#                    resp = getattr(obj, method)(json.dumps(defaults["awayColor"]))
                    method ='setAwayScore'
                    print(away_score)
                    if away_score<99:
...
#                 away_score= obj.awayScore
                    ...
                    if Inning1<15:
                       Inning1=Inning1+1
                       Inning_number1=Inning1
                       params="t"+str(Inning_number1)
                       resp = getattr(obj, method)(params)
                 elif Score_mode==3:
                    method ='setInning'
#                 away_score= obj.awayScore
                    print("Botttom Inning") 
                    print(Inning2)
                    if Inning2<15:
                       Inning2=Inning2+1
                       Inning_number2 =Inning2
                       params='b'+str(Inning_number2)
                       resp = getattr(obj, method)(params)
                 elif Score_mode==4:
                    method ='setBalls'
#                 away_score= obj.awayScore
...
#                 away_score= obj.awayScore
                    print(Strikes_score)
                    if Strikes_score<2:
                       Strikes_score=Strikes_score+1
                       params=str(Strikes_score)
                       resp = getattr(obj, method)(params)
                 else :
                    method ='setOuts'
#                 away_score= obj.awayScore
                    print(Outs_score)
                    if Outs_score<2:
                       Outs_score=Outs_score+1
                       params=str(Outs_score)
                       resp = getattr(obj, method)(params)
...
#                 away_score= obj.awayScore
                    ...
                    method ='setWeightClass'
#                 away_score= obj.awayScore
                    print(Weight_class)
                    if Weight_class<300:
                       Weight_class=Weight_class+1
                       params=str(Weight_class)
                       resp = getattr(obj, method)(params)


              if game_id==8 or game_id==9:
                 print("Increment-Swimming")
                 print(Score_mode)
                 if Score_mode==1:
                    method ='setAwayScore'
                    print(away_score)
...
#                 away_score= obj.awayScore
              ...
              if game_id==10:
                 if Score_mode==1:
                    method ='setAwayScore'
                    print("Away score in Keypad")
                    print(away_score)
                    if away_score!="AD":
                        if away_score<40:
                           print("Away score <45")
                           if away_score<30:
                              away_score=away_score+15
                           else:
                              away_score=away_score+10
                        elif away_score==40:
                           print("Away score AD")
                           away_score='AD'
                        params=str(away_score)
...
#                 away_score= obj.awayScore
                    print(H_Set1score)
                    if H_Set1score<7:
                       H_Set1score=H_Set1score+1
                       Set1Score=dict(setID="h1",score=str(H_Set1score))
                       params=json.dumps(Set1Score,indent=4)
#                       params=jsonify(Set1Score)
                       resp = getattr(obj, method)(params)
...
#                 away_score= obj.awayScore
                    print(H_Set2score)
                    if H_Set2score<7:
                       H_Set2score=H_Set2score+1
                       Set2Score=dict(setID="h2",score=str(H_Set2score))
                       params=json.dumps(Set2Score,indent=4)
#                       params=jsonify(Set2Score)
                       resp = getattr(obj, method)(params)
...
#                 away_score= obj.awayScore
                    print(H_Set3score)
                    if H_Set3score<7:
                       H_Set3score=H_Set3score+1
                       Set3Score=dict(setID="h3",score=str(H_Set3score))
                       params=json.dumps(Set3Score,indent=4)
                       resp = getattr(obj, method)(params)
...
#                 away_score= obj.awayScore
                    print(G_Set1score)
                    if G_Set1score<7:
                       G_Set1score=G_Set1score+1
                       Set1Score=dict(setID="a1",score=str(G_Set1score))
                       params=json.dumps(Set1Score,indent=4)
                       resp = getattr(obj, method)(params)
...
#                 away_score= obj.awayScore
                    print(G_Set2score)
                    if G_Set2score<7:
                       G_Set2score=G_Set2score+1
                       Set2Score=dict(setID="a2",score=str(G_Set2score))
                       params=json.dumps(Set2Score,indent=4)
                       resp = getattr(obj, method)(params)
...
#                 away_score= obj.awayScore
                    print(G_Set3score)
                    if G_Set3score<7:
                       G_Set3score=G_Set3score+1
                       Set3Score=dict(setID="a3",score=str(G_Set3score))
                       params=json.dumps(Set3Score,indent=4)
                       resp = getattr(obj, method)(params) 
              if game_id==11:
                 if Score_mode==0:
...
#                 away_score= obj.awayScore
                    ...
                    if Inning2<15:
                       Inning2=Inning2+1
                       Inning_number2 =Inning2
                       params='h'+str(Inning_number2)
                       resp = getattr(obj, method)(params)
                 elif Score_mode==4:
                    method ='setAwaywinscore'
#                 away_score= obj.awayScore
                    print(Awaywin_score)
                    if Awaywin_score<99:
                       Awaywin_score=Awaywin_score+1
                       params=str(Awaywin_score)
                       resp = getattr(obj, method)(params)
                 elif Score_mode==5:
                    method ='setHomewinscore'
#                 away_score= obj.awayScore
                    print(Homewin_score)
                    if Homewin_score<99:
                       Homewin_score=Homewin_score+1
                       params=str(Homewin_score)
                       resp = getattr(obj, method)(params)
...
#                  timer_status=1
                  ...
                  print("Game ID")
                  print(game_id)
                  print("Game id printed")
                  if game_id==10:
                      if H_Set1score<7 and G_Set1score<7:
                        if H_Set1score==0 and G_Set1score==0 and Score_mode!=5:
                            Score_mode=5
                                                   
                        elif Score_mode==0 or Score_mode==1:
                            print("Set1 Home Selected")
                            Score_mode=5
                        elif Score_mode==2:
                            print("Set1 Home Selected")
                            Score_mode=5
                        elif Score_mode==5:
                            print("Set1 Away Selected")
                            Score_mode=2
                      elif H_Set2score<7 and G_Set2score<7:
                        if H_Set2score==0 and G_Set2score==0 and Score_mode!=6:
                            Score_mode=6
                        elif Score_mode==0 or Score_mode==1:
                            Score_mode=6
                        elif Score_mode==3:
                      ...
                      elif H_Set3score<7 and G_Set3score<7:
                        print("Set3 Entered")
                        if H_Set3score==0 and G_Set3score==0 and Score_mode!=7:
                            Score_mode=7
                        elif Score_mode==0 or Score_mode==1:
                            Score_mode=7
                        elif Score_mode==4:
                      ...
                      if Score_mode !=4 and Score_mode!=5:
                        Score_mode=4
                      elif Score_mode==4:
                        Score_mode=5
                      elif Score_mode==5:
                      ...
                      print("Keypad Timer Pressed-Game12")                  
                      if timer_event.isSet()==0:
                         timer_event.set()
                         print("Timervalue:Keypad")
                         print(t)
                      else:
                         print("Timer toggled")
                         timer_event.clear()                  
                  else:
                      print("Keypad Timer Pressed")                  
                      if timer_event.isSet()==0:
                         timer_event.set()
                         print("Timervalue:Keypad")
                         print(t)
